 ...
 */
export const withNamespaceRegistry = <TBase extends RegistryStorageConstructor>(Base: TBase) =>
  class NamespaceRegistryMixin extends Base {
...
export class NamespaceRegistry extends withNamespaceRegistry(LocalRegistryStorage) {}

export type NamespaceRegistryClient = Pick<
  NamespaceRegistry,
  Extract<keyof NamespaceRegistry, string>
>;
